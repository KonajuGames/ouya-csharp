...
public class PurchaseUtils
{
    ...
    public PurchaseUtils(byte[] applicationKey)
    {
    ...
    public Purchasable CreatePurchasable(Product product, String uniquePurchaseId) 
    {
    ...
    public boolean IsPurchaseResponseMatching(String purchaseResponse, Product product, String uniquePurchaseId)
    {
        try
        {
            OuyaEncryptionHelper helper = new OuyaEncryptionHelper();
            ...
            else 
            {
                ...
                if (!p.getIdentifier().equals(product.getIdentifier()))
                    return false;
            }
        } catch (ParseException e) { 
